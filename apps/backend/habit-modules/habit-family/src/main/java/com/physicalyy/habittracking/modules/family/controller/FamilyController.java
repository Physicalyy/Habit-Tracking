...
public class FamilyController {
    ...
    public ApiResult<CreateFamilyResponse> createFamily(
        ...
        return ApiResult.ok(familyService.createFamily(request));
    }
    ...
    public ApiResult<JoinFamilyResponse> joinFamily(
        ...
        return ApiResult.ok(familyService.joinFamily(request));
    }
    ...
    public ApiResult<InviteCodeSummary> getInviteCode(
        ...
        return ApiResult.ok(familyService.getActiveInviteCode(familyId));
    }
    ...
    public ApiResult<List<FamilyMemberSummary>> listFamilyMembers(
        ...
        return ApiResult.ok(familyService.listFamilyMembers(familyId));
    }
    ...
    public ApiResult<InviteCodeSummary> refreshInviteCode(
        ...
        return ApiResult.ok(familyService.refreshInviteCode(familyId));
    }
}
