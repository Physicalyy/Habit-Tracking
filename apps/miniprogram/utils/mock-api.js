...
const mockHabitTemplates = Object.freeze([
  ...
  Object.freeze({
    ...
    ageMax: 12,
    iconKey: "soap",
    imageUrl: "/assets/habits/brush-teeth.png",
    sourceType: "SYSTEM",
    status: "active",
  }),
  Object.freeze({
    ...
    ageMax: 10,
    iconKey: "menu_book",
    imageUrl: "/assets/habits/read-books.png",
    sourceType: "SYSTEM",
    status: "active",
  }),
  Object.freeze({
    ...
    ageMax: 12,
    iconKey: "assignment",
    imageUrl: "/assets/habits/prepare-schoolbag.png",
    sourceType: "SYSTEM",
    status: "active",
  }),
  Object.freeze({
    ...
    imageUrl: "/assets/habits/jump-rope.png",
    sourceType: "SYSTEM",
    status: "active",
  }),
  Object.freeze({
    ...
    ageMax: 12,
    iconKey: "traffic",
    imageUrl: "/assets/habits/watch-traffic.png",
    sourceType: "SYSTEM",
    status: "active",
  }),
]);
